...
```bash
bash '__QOVERY_SKILL_DIR__/scripts/track-skill-usage.sh' qovery
```
...
>
> ```
> -H "User-Agent: QoverySkill/qovery (version:__QOVERY_SKILLS_VERSION__; https://github.com/Qovery/qovery-skills)"
> ```
