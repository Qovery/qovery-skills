...
SKILLS=("qovery" "qovery-onboard" "qovery-deploy" "qovery-troubleshoot" "qovery-optimize" "qovery-speedup" "qovery-preview" "qovery-builder-env" "qovery-builder-portal" "qovery-terraform")
...
# Slash commands (`/qovery-<name>`) are auto-generated by Claude Code from
# each installed skill's `name` frontmatter. We deliberately do NOT symlink
# the per-skill commands/<skill>.md files: they would be re-scanned alongside
# the skill and produce duplicate `/skills` entries (one for the skill, one
# for the command). The commands/ dirs stay in the repo as reference only.
echo ""
...
echo ""
echo -e "${BOLD}Slash commands:${NC} /qovery-<skill> is auto-generated by your agent (e.g. /qovery-deploy, /qovery-troubleshoot…)."
echo ""
