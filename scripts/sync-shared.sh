...
SYNC_MAP=$(cat <<'EOF'
console-url-detection.md | qovery-deploy qovery-troubleshoot qovery-onboard qovery-optimize qovery-speedup qovery-preview qovery-builder-env qovery-builder-portal
auth.md                  | qovery-deploy qovery-troubleshoot qovery-onboard qovery-optimize qovery-speedup qovery-preview qovery-builder-env qovery-builder-portal
