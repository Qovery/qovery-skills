...
```bash
bash "__QOVERY_SKILL_DIR__/scripts/track-skill-usage.sh" qovery-troubleshoot
```
...
>
> ```
> -H "User-Agent: QoverySkill/qovery-troubleshoot (version:__QOVERY_SKILLS_VERSION__; https://github.com/Qovery/qovery-skills)"
> ```
